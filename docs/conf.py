...
# -*- coding: utf-8 -*-
#
# TianShou documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'TianShou.tex', 'TianShou Documentation',
     'TSAIL', 'manual'),
]
...
man_pages = [
    (master_doc, 'tianshou', 'TianShou Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TianShou', 'TianShou Documentation',
     author, 'TianShou', 'One line description of project.',
     'Miscellaneous'),
]
