...
class View(object):
    def __init__(self, args, masked_indices=[], name=None):
        ...
        self._view_mask = torch.ones(int(np.prod(self.state_shape)))
...
def test_ddpg(args=get_args()):
    A = View(args, masked_indices=[0], name='A')
    B = View(args, masked_indices=[1], name='B')
    ...
    result = offpolicy_trainer_with_views(
        ...
        alpha=args.alpha, task=args.task)
