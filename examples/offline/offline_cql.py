...
def test_bcq():
    ...
    cql_log_alpha = torch.tensor([0.0], requires_grad=True)
    cql_alpha_optim = torch.optim.Adam([cql_log_alpha], lr=args.alpha_lr)
    ...
    policy = CQLPolicy(
        ...
        critic2,
        critic2_optim,
        cql_log_alpha=cql_log_alpha,
        cql_alpha_optim=cql_alpha_optim,
