#!/bin/bash
CUDA_VISIBLE_DEVICES=0 python ant_v2_td3.py \
--task "HalfCheetah-v3" \
...
CUDA_VISIBLE_DEVICES=1 python ant_v2_td3.py \
--task "Walker2d-v3" \
...
CUDA_VISIBLE_DEVICES=2 python ant_v2_td3.py \
--task "Humanoid-v3" \
...
CUDA_VISIBLE_DEVICES=3 python ant_v2_td3.py \
